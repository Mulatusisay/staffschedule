...
<head>
    ...
    <!-- DATA TABLES -->
    <link href="${request.contextPath}/starter/plugin/datatables/dataTables.bootstrap.css" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
...
<script src="${request.contextPath}/starter/dist/js/demo.js" type="text/javascript"></script>
<!-- page script -->
