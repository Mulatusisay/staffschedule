...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="www.ethiopianairlines.com" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b>A</b>ET</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Admin</b>ET</span>
    </a>
...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active"><a href="phoneDirectory/index"><i class='fa fa-link'></i> <span>Phone Directory</span></a></li>
            <li><a href="claimLostItem/index"><i class='fa fa-link'></i> <span>Baggage Claim</span></a></li>
            <li><a href="home/index.gsp"><i class='fa fa-link'></i> <span>HOME</span></a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="staff/index"><i class="fa fa-circle-o"></i>Claim Lost Item</a></li>
                    <li><a href="attendance/index"><i class="fa fa-circle-o"></i>Phone Directory</a></li>
                </ul>
            </li>
