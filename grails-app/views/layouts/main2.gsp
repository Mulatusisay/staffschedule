...
<head>
    ...
    <link href="${request.contextPath}/starter/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css" rel="stylesheet" type="text/css" />
...
<div class="wrapper">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="${request.contextPath}/starter/dist/img/user3-128x128.jpg" class="img-circle" alt="user image"/>
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="${request.contextPath}/starter/dist/img/user4-128x128.jpg" class="img-circle" alt="user image"/>
                                            </div>
                                            <h4>
                                                Developers
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="${request.contextPath}/starter/dist/img/user2-160x160.jpg" class="user-image" alt="User Image"/>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="${request.contextPath}/starter/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
    ...
    <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
            <b>Anything you</b> want
        </div>
        <!-- Default to the left -->
        <strong>Copyright &copy; 2015 <a href="#">Ethiopian Airlines</a>.</strong> All rights reserved.
    </footer>
